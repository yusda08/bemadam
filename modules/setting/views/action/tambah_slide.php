    ...
    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal aksi_form_user" action="<?= site_url('setting/Set_slide/insertSlideShow'); ?>" method="POST">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input type="text" class="form-control judul" name="judul" placeholder="Judul Slide Show" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <textarea type="email" class="form-control keterangan" name="keterangan" placeholder="Keterangan" ></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
